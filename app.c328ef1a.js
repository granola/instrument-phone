...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scale.js":[function(require,module,exports) {
"use strict";
...
// in backend
var oscClientIP = '192.168.10.109';
var oscClientPort = 8000; // in frontend

var backendPort = 3000;
var backendOrigin = 'http://localhost:' + backendPort;
module.exports = {
  oscClientIP: oscClientIP,
...
var socket = (0, _socket.default)(_config.backendOrigin);
socket.on("connect", function () {
  console.debug("socket connected");
});
var isMute = true;
var topPositionHz = _scale.default.c4;
...
var betaHelz = document.getElementById('helz');
window.addEventListener("deviceorientation", function (e) {
  var adjustedBeta = Math.round(e.beta + 180);
  var percent = adjustedBeta / 90;
  var hz = topPositionHz + topPositionHz * percent;
  betaHelz.innerHTML = Math.round(hz);
  if (isMute) return;
  oscillator.frequency.value = hz;
  gainNode.gain.value = e.gamma;
}, true);
window.addEventListener('devicemotion', (0, _lodash.default)(function (e) {
  if (isMute) return;
...
},{"./scale.js":"scale.js","socket.io-client":"node_modules/socket.io-client/lib/index.js","lodash.throttle":"node_modules/lodash.throttle/index.js","./config":"config.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
